/// @file TicoOverlay.h
/// @brief Overlay UI for tico-integrated fceumm
#pragma once
...
/// @brief Overlay UI for fceumm with tico styling
class TicoOverlay
{
public:
    TicoOverlay();
...
private:
    ...
    FceummDisplayMode m_displayMode = FceummDisplayMode::Display;
    FceummDisplaySize m_displaySize = FceummDisplaySize::_4_3;
